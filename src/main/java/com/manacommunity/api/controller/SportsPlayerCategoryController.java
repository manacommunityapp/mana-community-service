...
public class SportsPlayerCategoryController {

    private final SportsPlayerCategoryService categoryService;
    private final LoggedInUserService loggedInUserService;
    private final PermissionCheckService permissionCheckService;

    @GetMapping
    public ResponseEntity<List<SportsPlayerCategory>> getCategories(
    ...
    @PostMapping
    public ResponseEntity<SportsPlayerCategory> createCategory(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SportsPlayerCategory> updateCategory(
