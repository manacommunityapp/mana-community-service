...
import com.manacommunity.api.dto.SportsTournamentResponse;
...
public class SportsTournamentController {
    ...
    private final com.manacommunity.api.email.SportsTournamentEmailService tournamentEmailService;

    @GetMapping("/announcement/{id}")
    public ResponseEntity<com.manacommunity.api.dto.email.SportsTournamentAnnouncementEmailDTO> announcement(@PathVariable Long id) {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<SportsTournamentResponse>> getAllTournaments(@AuthenticationPrincipal UserPrincipal principal) {
        return ResponseEntity.ok(tournamentService.getAllTournaments().stream().map(this::toResponse).toList());
    }

    @GetMapping("/community")
    public ResponseEntity<List<SportsTournamentResponse>> getCommunityTournaments(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SportsTournamentResponse> getTournamentById(@PathVariable Long id) {
    ...
    private SportsTournamentResponse toResponse(SportsTournament t) {
        ...
        return SportsTournamentResponse.builder()
                .id(t.getId())
                .name(t.getName())
