...
public class EventExpenseService {
    ...
    public EventExpenseResponse create(EventExpenseRequest req, AppUser user, Community community) {
        ...
        EventExpense expense = EventExpense.builder()
                ...
                .status(parseEnumOrDefault(EventExpense.ExpenseStatus.class, req.getStatus(), EventExpense.ExpenseStatus.PENDING))
                .community(community)
                .createdBy(user)
                .build();
    ...
    public EventExpenseResponse update(Long id, EventExpenseRequest req) {
        ...
        e.setStatus(parseEnumOrDefault(EventExpense.ExpenseStatus.class, req.getStatus(), e.getStatus()));
