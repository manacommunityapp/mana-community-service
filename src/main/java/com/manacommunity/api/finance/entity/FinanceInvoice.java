...
/**
 * Customer invoice (Income → Invoices menu). Standalone table so the invoice menu
 * is fully independent of the other financial documents.
 */
@Entity
...
public class FinanceInvoice {
    ...
    /** Human-readable code, e.g. INV/001. */
    @Column(length = 24)
    private String code;
    ...
    @ElementCollection
    @CollectionTable(name = "finance_invoice_line", joinColumns = @JoinColumn(name = "invoice_id"))
    @Builder.Default
