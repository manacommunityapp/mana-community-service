...
@Entity
@Table(name = "food_catering_orders")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class FoodCateringOrder {
    ...
    private FoodCateringQuotation quotation;
    ...
    @Builder.Default
    private CateringOrderStatus status = CateringOrderStatus.CONFIRMED;
    ...
    public enum CateringOrderStatus { CONFIRMED, PREPARING, DELIVERED, COMPLETED }
}
