...
/**
 * A gallery/memory tile attached to a {@link SportsTournament}, shown in the
 * "Memories &amp; Gallery" section of the announcement email.
 */
@Entity
@Table(name = "sports_tournament_gallery_image")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SportsTournamentGalleryImage {
