...
/**
 * A custom milestone attached to a {@link SportsTournament}, shown in the
 * "SportsTournament Timeline" section of the announcement email. When no custom
 * entries exist the service falls back to milestones derived from the
 * tournament's own registration/event dates.
 */
@Entity
@Table(name = "sports_tournament_timeline_entry")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SportsTournamentTimelineEntry {
