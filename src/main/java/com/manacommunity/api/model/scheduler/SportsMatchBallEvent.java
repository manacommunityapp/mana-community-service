...
@Entity @Table(name = "sports_match_ball_event")
@Data @Builder @NoArgsConstructor @AllArgsConstructor
public class SportsMatchBallEvent {
    ...
    private SportsAuctionPlayer dismissedPlayer;
    ...
    private SportsAuctionPlayer batsman;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "non_striker_id")
    private SportsAuctionPlayer nonStriker;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "bowler_id", nullable = false)
    private SportsAuctionPlayer bowler;
