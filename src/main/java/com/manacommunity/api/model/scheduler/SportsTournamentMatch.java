...
@Entity @Table(name = "sports_tournament_match")
@Data @Builder @NoArgsConstructor @AllArgsConstructor
public class SportsTournamentMatch {
    ...
    private SportsTournamentGroup group;   // null for knockout rounds
    ...
    private SportsAuctionTeam winner;
