...
public interface SportsEventRepository extends JpaRepository<SportsEvent, Long> {
    ...
    List<SportsEvent> findByCommunityIdAndTournamentRegistrationStatusInOrderByEventDateStartAsc(
            Long communityId, List<com.manacommunity.api.model.SportsEventStatus> registrationStatuses);
    ...
    @Query("""
        ...
        AND e.tournament.registrationStatus <> com.manacommunity.api.model.SportsEventStatus.CANCELLED
    ...
    List<SportsEvent> findByTournamentRegistrationStatusOrderByEventDateStartAsc(com.manacommunity.api.model.SportsEventStatus registrationStatus);
    ...
    long countByTournamentRegistrationStatus(com.manacommunity.api.model.SportsEventStatus registrationStatus);

    long countByCommunityIdAndTournamentRegistrationStatus(Long communityId, com.manacommunity.api.model.SportsEventStatus registrationStatus);

    long countByCommunityIdAndTournamentRegistrationStatusIn(Long communityId, List<com.manacommunity.api.model.SportsEventStatus> registrationStatuses);
}
