...
import com.manacommunity.api.dto.SportsAuctionBidResponse;
import com.manacommunity.api.dto.SportsAuctionStatsResponse;
...
@Slf4j
@Service
public class SportsAuctionWebSocketService {

    private final SimpMessagingTemplate messagingTemplate;

    public SportsAuctionWebSocketService(@Autowired(required = false) SimpMessagingTemplate messagingTemplate) {
    ...
    public void broadcastBid(Long configId, SportsAuctionBidResponse bid) {
