...
import com.manacommunity.api.repository.scheduler.SportsScheduleGenerationLogRepository;
...
public class SportsScheduleGenerationLogService {

    private final SportsScheduleGenerationLogRepository logRepo;
    ...
    public SportsScheduleGenerationLog log(
        ...
        SportsScheduleGenerationLog entry = SportsScheduleGenerationLog.builder()
                .configId(configId)
                .eventId(eventId)
    ...
    public List<SportsScheduleGenerationLogResponse> getLogsByConfig(Long configId) {
        return logRepo.findByConfigIdOrderByCreatedAtDesc(configId)
                .stream().map(this::toResponse).toList();
    }

    public List<SportsScheduleGenerationLogResponse> getLogsByEvent(Long eventId) {
        return logRepo.findByEventIdOrderByCreatedAtDesc(eventId)
                .stream().map(this::toResponse).toList();
    }

    public Page<SportsScheduleGenerationLogResponse> getLogsByCommunity(Long communityId, int page, int size) {
    ...
    private SportsScheduleGenerationLogResponse toResponse(SportsScheduleGenerationLog e) {
        ...
        return new SportsScheduleGenerationLogResponse(
