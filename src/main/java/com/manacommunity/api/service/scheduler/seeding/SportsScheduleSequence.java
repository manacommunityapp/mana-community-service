 ...
 * to a dedicated {@link SportsSeedingStrategy} that pairs players differently:
 *
 * <ul>
 ...
 * </ul>
 */
public enum SportsScheduleSequence {
    RANDOM,
    TRADITIONAL,
    SEQUENTIAL;
     ...
     */
    public static SportsScheduleSequence fromUi(String value) {
