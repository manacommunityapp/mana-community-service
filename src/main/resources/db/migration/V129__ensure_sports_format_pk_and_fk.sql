-- =====================================================================
-- V129: Idempotent safety net — same as V128 but runs after it.
--       Skips all column/sequence/PK work if PK already exists.
--       Handles BIGSERIAL and GENERATED ALWAYS AS IDENTITY columns.
-- =====================================================================
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        IF NOT is_identity THEN
            -- A3a. Regular column: attach sequence if missing
        ...
        ELSE
            -- A3b. Identity column: locate its internal sequence
