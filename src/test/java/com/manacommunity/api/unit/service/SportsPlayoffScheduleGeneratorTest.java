...
@DisplayName("SportsPlayoffScheduleGenerator - rounds-to-final bracket")
class SportsPlayoffScheduleGeneratorTest {

    private final SportsPlayoffScheduleGenerator generator = new SportsPlayoffScheduleGenerator();

    private SportsPlayoffGenerateRequest request(int numGroups, int proceeders, String seeding,
                                           boolean thirdPlace) {
        return new SportsPlayoffGenerateRequest(
    ...
    private static SportsPlayoffGenerateRequest.ParticipantInput player(String id, String name, String flat) {
        return new SportsPlayoffGenerateRequest.ParticipantInput(id, name, flat);
    }

    private SportsPlayoffGenerateRequest knockoutRequest(
            List<SportsPlayoffGenerateRequest.ParticipantInput> players, List<Long> courtIds) {
        return new SportsPlayoffGenerateRequest(
    ...
    class TwoGroupTwoProceeder {
        ...
        void crossSemisAndFinal() {
            List<SportsPlayoffMatchDraftResponse> matches =
                    generator.buildPlayoffBracket(request(2, 2, "TRADITIONAL", false));

            assertThat(matches).hasSize(3);
            assertThat(matches).extracting(SportsPlayoffMatchDraftResponse::round)
        ...
        void thirdPlaceAdded() {
            ...
            SportsPlayoffMatchDraftResponse third = matches.get(3);
    ...
    class GeneralBracket {
        ...
        void oddCountByes() {
            ...
            SportsPlayoffMatchDraftResponse bye = matches.stream()
            ...
            long distinctRealTimes = matches.stream()
                    ...
                    .map(SportsPlayoffMatchDraftResponse::time)
                    .distinct().count();
    ...
    class RoundNaming {
        ...
        void roundNames() {
            assertThat(SportsPlayoffScheduleGenerator.getRoundName(2, 3)).isEqualTo("FINAL");
            assertThat(SportsPlayoffScheduleGenerator.getRoundName(1, 3)).isEqualTo("SEMI_FINAL");
            assertThat(SportsPlayoffScheduleGenerator.getRoundName(0, 3)).isEqualTo("QUARTER_FINAL");
            assertThat(SportsPlayoffScheduleGenerator.getRoundName(0, 5)).isEqualTo("Round 1");
        }
    }
    ...
    class TimeHelpers {
        ...
        void addMinutes() {
            assertThat(SportsPlayoffScheduleGenerator.addMinutesToTime("08:00 AM", 40)).isEqualTo("08:40 AM");
            assertThat(SportsPlayoffScheduleGenerator.addMinutesToTime("11:50 AM", 20)).isEqualTo("12:10 PM");
            assertThat(SportsPlayoffScheduleGenerator.addMinutesToTime("11:30 PM", 40)).isEqualTo("12:10 AM");
        }
    }
    ...
    class KnockoutFromPlayers {
        ...
        private List<SportsPlayoffGenerateRequest.ParticipantInput> players(int n) {
            List<SportsPlayoffGenerateRequest.ParticipantInput> list = new ArrayList<>();
            for (int i = 0; i < n; i++) {
                char tower = (char) ('A' + i);
        ...
        void thirteenPlayersThreeByes() {
            ...
            List<SportsPlayoffMatchDraftResponse> byes = matches.stream()
        ...
        void avoidsSameFlatAndTower() {
            ...
            List<SportsPlayoffGenerateRequest.ParticipantInput> ps = List.of(
                    player("p1", "P1", "A101"),
                    player("p2", "P2", "B101"),
                    player("p3", "P3", "C101"),
                    player("p4", "P4", "A202"));

            List<SportsPlayoffMatchDraftResponse> round1 =
        ...
        void parallelCourtWaves() {
            ...
            assertThat(round1.subList(0, 4)).extracting(SportsPlayoffMatchDraftResponse::courtId)
